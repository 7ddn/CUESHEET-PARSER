...
parser.add_argument('-r', '--rename', help = 'rename the audio file also', action='store_true')
...
cb.save_parsed_cue_to_cue_sheet(filled, args.save_name, args.save_dir, args.rename)